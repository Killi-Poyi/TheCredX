...
// This is a minimal "dummy" route for debugging.
...
export async function GET(
  ...
  // Simply return a success message with the ID we received.
  return NextResponse.json({
    message: `API route is working for website ID: ${websiteid}`,
  });
}
